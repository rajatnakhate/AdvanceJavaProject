...
<spr:form action="stud_reg.htm" method="post" commandName="student">
<table>
			...
			<tr>
				...
				<td><spr:select path="city">
						...
						<spr:option value="kolhapur">Kolhapur</spr:option>
			...
			<tr>
				<td><spr:button style="background-color:green">Register</spr:button></td>
			</tr>
